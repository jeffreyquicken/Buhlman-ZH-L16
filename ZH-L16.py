...
def initialise_compartments(p_ambient):
    p_N = round(0.79 * (p_ambient - PP_WATERPRESSURE), 4)  # Initial value of nitrogen loading in all compartments
    compartments = {
        "1": {"p_N": p_N, "p_He": 0, "p_total": p_N},
        "1.1": {"p_N": p_N, "p_He": 0, "p_total": p_N},
